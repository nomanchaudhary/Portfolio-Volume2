...
function About() {
  const AnimatedNumbers = ({ value }) => {
    ...
    const motionvalue = useMotionValue(0); // Declare inside the component
  ...
  return (
    <main className="flex flex-col justify-center items-center w-full dark:bg-black dark:text-white">
      ...
      <div className="grid grid-cols-8 gap-16 w-full px-32">
        ...
        <div  className="col-span-3 h-max relative border-2 border-solid bg-white dark:bg-black rounded-2xl rounded-br-2xl p-8 mt-10 shadow-[10px_10px_0px_0px_rgba(0,_0,_0,_1)] dark:shadow-[10px_10px_0px_0px_rgba(255,_255,_255,_1)]">
          <img
            src={profilePic}
            alt="Noman Chaudhary"
